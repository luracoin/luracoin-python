...
class TransactionsTest(LuracoinTest):
    ...
    def test_chainstate(self) -> None:
        ...
        tx2 = Transaction(
            ...
            txins=[
                TxIn(
                    to_spend=OutPoint(tx.id, 0), unlock_sig="test", sequence=0
                )
            ],
            txouts=[
                TxOut(
    ...
    def test_validate_tx(self) -> None:
        ...
        tx_0 = Transaction(
            ...
            txouts=[
                TxOut(
                    value=5_000_000_000, to_address=build_p2pkh(self.address1)
                )
            ],
        )
        ...
        tx_test_1 = Transaction(
            ...
            txouts=[
                TxOut(
                    value=3_000_000_000, to_address=build_p2pkh(self.address1)
                )
            ],
        )
        ...
        tx_test_3 = Transaction(
            ...
            txouts=[
                TxOut(
                    value=5_100_000_000, to_address=build_p2pkh(self.address1)
                )
            ],
        )
        ...
        tx_test_4 = Transaction(
            ...
            txouts=[
                TxOut(
                    value=4_900_000_000, to_address=build_p2pkh(self.address1)
                ),
                TxOut(
                    value=200_000_000, to_address=build_p2pkh(self.address1)
                ),
            ],
        )
        ...
        tx_test_5 = Transaction(
            ...
            txins=[
                TxIn(
                    to_spend=OutPoint(self.tx0, 0), unlock_sig="0", sequence=0
                )
            ],
            txouts=[
                TxOut(
                    value=2_100_004_900_000_000,
    ...
    def test_validate_signature(self) -> None:
        ...
        v1 = validate_signature(
            TxIn(to_spend=OutPoint(self.tx1.id, 0), unlock_sig="-", sequence=0)
        )
        self.assertFalse(v1)
