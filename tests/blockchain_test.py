...
class LuracoinTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        # User 1
        cls.public_key1 = (
            "79b043fbab0aa455d0fd9a38f1befcf1c7116feedd7407f"
        ...
        # User 2
        cls.public_key2 = (
            "7b11afeeb5e0a40d14541774c5cf8db6c22dfc98594ca88"
        ...
        cls.private_key2 = (
            b"\xea\xe1\xb8-\xdc\x9fd\xc2\x07/]\x1a\t\xac|"
        ...
        # User 3
        cls.public_key3 = (
            "cd1aee50b5e08b2b9512ed72c6aefbb35f762512b05a971"
        ...
        cls.private_key3 = (
            b"\xc6H\t\xa6y\x8d\xa9\x1dj\xf6\xa0\xbb\xd4:"
            b"\xbbi\xe5.GMH~\x00\xc5\x02\x97k\x01)[B\xf5"
        )

        # User 4
        cls.public_key4 = (
            "f4b076bfcdb1f782018d2e3afa195ae1c92f18b3f97ba0c"
        ...
        cls.private_key4 = (
            b"\x13\x18\xff\xfd]\x18-.\xa7\xb6\x0c\xeaX\xf6&"
        ...
        cls.tx0 = Transaction(
            ...
            txouts=[
                TxOut(
                    value=5_000_000_000, to_address=build_p2pkh(cls.address1)
                )
            ],
            locktime=0,
        )
        ...
        signature = bytes_to_signing_key(cls.private_key1).sign(
            build_message(OutPoint(cls.tx0.id, 0), cls.public_key1).encode()
        )
        ...
        cls.tx2 = Transaction(
            ...
            txins=[
                TxIn(
                    to_spend=OutPoint(cls.tx0.id, 0),
                    sequence=0,
                    unlock_sig=build_script_sig(
                        signature.hex(), cls.public_key1
                    ),
                )
            ],
            txouts=[
                TxOut(
                    value=1_000_000_000, to_address=build_p2pkh(cls.address2)
                ),
                TxOut(
                    value=2_000_000_000, to_address=build_p2pkh(cls.address3)
                ),
                TxOut(
                    value=2_000_000_000, to_address=build_p2pkh(cls.address4)
                ),
            ],
            locktime=0,
        )
