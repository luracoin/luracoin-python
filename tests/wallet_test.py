...
class BlocksTest(unittest.TestCase):
    ...
    def test_bytes_to_signing_key(self):
        sig_key = bytes_to_signing_key(
            (b'\xb1\x80E\xceRo\xfeG[\x89\xe2\xc1+\xfd\xf9\xc4\x80w'
             b'\x91\x836o~\xbe\x87\x82bb\xab@\xf9N')
        )
        self.assertEqual(
            sig_key.to_string().hex(),
            'b18045ce526ffe475b89e2c12bfdf9c480779183366f7ebe87826262ab40f94e'
        )
